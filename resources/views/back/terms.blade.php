...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Terms Of Use</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="col-sm-12 col-xl-12 card">
                    <div class=" rounded h-100 card-body">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h4 class="mb-0 mt-4">Our terms text</h4>
                        </div>
                        <div id="alert_description_en"></div>
                        <p class="mt-4">English text: </p>
                        @php $description = json_decode($get_terms_info->description); @endphp
                        <form method="post" id="update_our_terms_en">
                            @csrf
                            <div class="d-flex mb-2 p-4 form-floating card">
                                <textarea name="description_en" placeholder="Enter our terms text (english)" class="form-control"
                                    id="description_en">{{$description->en ?? ''}}</textarea>
                                <button class="btn btn-primary ms-2 mt-3">Update</button>
                            </div>
                        </form>
                        <div id="alert_description_ar"></div>
                        <p class="mt-4">Arabic text: </p>
                        <form method="post" id="update_our_terms_ar">
                            @csrf
                            <div class="d-flex mb-2 p-4 form-floating card">
                                <textarea name="description_ar" placeholder="Enter our terms text (arabic)" class="form-control" id="description_ar">{{$description->ar ?? ''}}</textarea>
                                <button class="btn btn-primary ms-2 mt-3">Update</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body row">
                        <div class="col-sm-12 col-xl-6 mt-4">
                            ...
                            @php $meta_title = json_decode($get_terms_info->meta_title); @endphp
                            ...
                            @php $meta_keywords = json_decode($get_terms_info->meta_keywords); @endphp
                            ...
                            @php $meta_description = json_decode($get_terms_info->meta_description); @endphp
...
@section('js')
    ...
    <script src="{{asset ('assets/js/backAssets/terms.js')}}"></script>
