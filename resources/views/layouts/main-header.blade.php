				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							...
							@else
								<a href="{{ url('/' . $page='index') }}"><img src="{{ asset(auth()->user()->image) }}" class="logo-1" alt="logo"></a>
							@endif
						</div>
					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<a href="{{ route('front.index') }}" target="_blank" class="mt-2">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								@else
									<a class="profile-user d-flex" href=""><img alt="" src="{{ asset(auth()->user()->image) }}"></a>
								@endif
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											@else
												<div class="main-img-user"><img alt="" src="{{ asset(auth()->user()->image) }}" class=""></div>
											@endif
											<div class="mr-3 my-auto ml-2">
												<h6>{{auth()->user()->first_name}} {{auth()->user()->last_name}}</h6><span>{{auth()->user()->email}}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{ route('backend.users.edit', auth()->user()->id) }}"><i class="bx bx-slider-alt"></i> Account Settings</a>
