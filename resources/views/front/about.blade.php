            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 order-md-1">
                    <div class="about-image">
                        <img src="{{ asset("/assets_front/images/about/3.jpg") }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="agents-carousel">
                        ...
                        <div class="col">
                            <div class="single-agent">
                                <div class="agent-image">
                                    <img src="{{ asset("/assets_front/images/agents/1.jpg") }}" alt="">
                                </div>
                                <div class="agent-info">
                                    <div class="agent-name">
                                        <h5><a href="{{ url("agent-details.html") }}">Shah M Nawaz</a></h5>
                                ...
                                <div class="agent-info-hover">
                                    ...
                                    <ul class="agent-address">
                                        <li><img src="{{ asset("/assets_front/images/icons/phone-2.png") }}" alt="">+1245 785 659 </li>
                                        <li><img src="{{ asset("/assets_front/images/icons/mail-close.png") }}" alt="">eva@gmail.com
                                        </li>
                                    </ul>
                                    <ul class="social-media">
                                        <li><a href="{{ url("#") }}"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                        </li>
                                        <li><a href="{{ url("#") }}"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                        </li>
                                        <li><a href="{{ url("#") }}"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                        </li>
                                        <li><a href="{{ url("#") }}"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="single-agent">
                                ...
                                <div class="agent-info">
                                    <div class="agent-name">
                                        <h5><a href="{{ url("agent-details.html") }}">Eva Sharlin</a></h5>
                        ...
                        <div class="col">
                            <div class="single-agent">
                                <div class="agent-image">
                                    <img src="{{ asset("/assets_front/images/agents/3.jpg") }}" alt="">
                                </div>
                                <div class="agent-info">
                                    <div class="agent-name">
                                        <h5><a href="{{ url("agent-details.html") }}">Robin Patrick</a></h5>
                                        <p>Real Estate Broker</p>
                                    </div>
                                </div>
                                <div class="agent-info-hover">
                        ...
                        <div class="col">
                            <div class="single-agent">
                                <div class="agent-image">
                                    <img src="{{ asset("/assets_front/images/agents/4.jpg") }}" alt="">
                                </div>
                                <div class="agent-info">
                                    <div class="agent-name">
                                        <h5><a href="{{ url("agent-details.html") }}">Sarmin Tabassum</a></h5>
                                        <p>Real Estate Agent</p>
                                    </div>
                                </div>
                                <div class="agent-info-hover">
