        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="breadcrumbs">
                    <h2 class="breadcrumbs-title">forleases</h2>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="flat-item">
                        <div class="flat-item-image">
                            <a href=""><img src="{{ asset("uploads/books/images/" . $forlease->image[0]) }}" alt=""></a>
                            <div class="flat-link">
                                <a href="{{ route('front.forlease.details', $forlease->id) }}">More Details</a>
                            </div>
                            <ul class="flat-desc">
                                <li>
                        ...
                        <div class="flat-item-info">
                            <div class="flat-title-price">
                                <h5><a href="{{ url("forleases-details.html") }}">{{ $forlease->name }} </a></h5>
                                <span class="price">${{$forlease->price}}</span>
                            </div>
                            <p><img src="{{ asset("/assets_front/images/icons/location.png") }}" alt="">{{ $forlease->location }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
